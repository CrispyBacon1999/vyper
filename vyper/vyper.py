...
class API():
    ...
    def configure(self, token, functions=None, debug=False):
        if not token or not isinstance(token, str):
            raise ValueError("Provide a valid token. Can be retrieved\
from @BotFather!")
        self._token = token
        self._debug = debug
    ...
    def request(self, endpoint, parameters=None, file=None):
        ...
        req = json.loads(
            requests.get(
                vyperconfig.apiurl.format(self._token, endpoint),
                params=parameters, files=file).text
                )
        if req['ok']:
            return req['result']
        else:
    ...
    def replyMessage(self, msg, text, parse_mode=None,
                     disable_web_page_preview=False,
                     disable_notification=False, reply_markup=None):
        self.sendMessage(msg['chat']['id'], text, parse_mode=parse_mode,
    ...
    def forwardMessage(self, chat_id, from_chat_id,
                       message_id, disable_notification=False):
        params = {
            'chat_id': chat_id,
    ...
    def sendPhoto(self, chat_id, photo, caption='', disable_notification=False,
                  reply_to_message_id=None, reply_markup=None):
        params = {
            'chat_id': chat_id,
            'caption': caption,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('sendPhoto', parameters=paramscleaned,
                            file={'photo': photo})

    def sendAudio(self, chat_id, audio, caption='', duration=None,
                  performer='', title='', disable_notification=False,
                  reply_to_message_id=None, reply_markup=None):
        params = {
            'chat_id': chat_id,
            'caption': caption,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('sendAudio', parameters=paramscleaned,
                            file={'audio': audio})

    def sendDocument(self, chat_id, document, caption='',
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('sendDocument', parameters=paramscleaned,
                            file={'document': document})

    def sendSticker(self, chat_id, sticker, disable_notification=False,
                    reply_to_message_id=None, reply_markup=None):
        params = {
            'chat_id': chat_id,
            'disable_notification': disable_notification,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('sendSticker', parameters=paramscleaned,
                            file={'sticker': sticker})

    def sendVideo(self, chat_id, video, duration=None, width=None,
                  height=None, caption='', disable_notification=False,
                  reply_to_message_id=None, reply_markup=None):
        params = {
            'chat_id': chat_id,
            'duration': duration,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('sendVideo', parameters=paramscleaned,
                            file={'video': video})
    ...
    def sendVoice(self, chat_id, voice, caption=None, duration=None,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('sendVoice', parameters=paramscleaned,
                            file={'voice': voice})

    def sendVideoNote(self, chat_id, video_note, length=None, duration=None,
                      disable_notification=False, reply_to_message_id=None,
                      reply_markup=None):
        params = {
            'chat_id': chat_id,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('sendVideoNote', parameters=paramscleaned,
                            file={'video_note': video_note})

    def sendLocation(self, chat_id, latitude, longitude, live_period=0,
                     disable_notification=False, reply_to_message_id=None,
                     reply_markup=None):
        params = {
            'chat_id': chat_id,
    ...
    def editMessageLiveLocation(self, chat_id=None, message_id=None,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('editMessageLiveLocation',
                            parameters=paramscleaned)

    def stopMessageLiveLocation(self, latitude, longitude, chat_id=None,
    ...
    def sendVenue(self, chat_id, latitude, longitude, title, address,
                  foursquare_id='', disable_notification=False,
                  reply_to_message_id=None, reply_markup=None):
        params = {
            'chat_id': chat_id,
            'latitude': latitude,
    ...
    def answerCallbackQuery(self, callback_query_id, text='',
                            show_alert=False, url='', cache_time=None):
        params = {
    ...
    def editMessageReplyMarkup(self, chat_id=None, message_id=None,
                               inline_message_id=None, reply_markup=None):
        params = {
            'chat_id': chat_id,
            'message_id': message_id,
    ...
    def sendInvoice(self, chat_id, title, description, payload, provider_token,
                    start_parameter, currency, prices, photo_url='',
                    photo_size=None, photo_height=None, photo_width=None,
    ...
    def answerShippingQuery(self, shipping_query_id, ok, shipping_options=None,
                            error_message=''):
        params = {
    ...
    # Games
    def sendGame(self, chat_id, game_short_name, disable_notification=False,
                 reply_to_message_id=None, reply_markup=None):
        params = {
            'chat_id': chat_id,
    ...
    def uploadStickerFile(self, user_id, png_sticker):
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('uploadStickerFile', parameters=paramscleaned,
                            file={'png_sticker': png_sticker})

    def createNewStickerSet(self, user_id, name, title, png_sticker, emojis,
                            contains_masks=False, mask_position=None):
        params = {
            'user_id': user_id,
            'name': name,
            'title': title,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('createNewStickerSet', parameters=paramscleaned,
                            file={'png_sticker': png_sticker})
    ...
    def addStickerToSet(self, user_id, name, png_sticker, emojis,
        ...
        paramscleaned = {k: v for k, v in params.items() if v}
        return self.request('addStickerToSet', parameters=paramscleaned,
                            file={'png_sticker': png_sticker})
